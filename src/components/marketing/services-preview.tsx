          ...
          <RevealItem key={s.slug}>
            ...
            >
              ...
              <div className="mt-4 flex items-start justify-between gap-3 border-t border-sand pt-4">
                ...
                <ArrowUpRight
                  className="mt-1 size-4 shrink-0 text-greige transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-lacquer"
                  aria-hidden
                />
              </div>
